...
public class GLSLStaticVec2dArray extends StaticStructArray<Vector2d> {

    private long byteSize;

    public GLSLStaticVec2dArray(int size) {
        super(new Vector2d[size]);
    }

    public GLSLStaticVec2dArray(Vector2d[] data) {
        super(data);
    }
