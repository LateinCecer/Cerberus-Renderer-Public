...
public class GLSLStaticVec4fArray extends StaticStructArray<Vector4f> {

    private long byteSize;

    public GLSLStaticVec4fArray(int size) {
        super(new Vector4f[size]);
    }

    public GLSLStaticVec4fArray(Vector4f[] data) {
        super(data);
    }
