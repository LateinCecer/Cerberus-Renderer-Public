...
public class GLSLStaticMat3fArray extends StaticStructArray<Matrix3f> {

    private long byteSize;

    public GLSLStaticMat3fArray(int size) {
        super(new Matrix3f[size]);
    }

    public GLSLStaticMat3fArray(Matrix3f[] data) {
        super(data);
    }
