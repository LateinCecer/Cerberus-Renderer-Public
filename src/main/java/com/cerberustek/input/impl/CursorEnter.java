...
import com.cerberustek.events.CursorEnterEvent;
import com.cerberustek.window.Window;
import com.cerberustek.input.InputDevice;
import org.lwjgl.glfw.GLFWCursorEnterCallback;

public class CursorEnter extends GLFWCursorEnterCallback implements InputDevice {
    ...
    public void invoke(long window, boolean enter) {
        ...
        eventService.executeFullEIF(new CursorEnterEvent(this, window, enter));
    }
