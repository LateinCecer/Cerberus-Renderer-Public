...
public class InverseTransformableBase implements Transformable {
    ...
    public InverseTransformableBase(Transformer transformer) {
        this.transformer = transformer;
    }

    public InverseTransformableBase() {
        transformer = new SimpleTransformer();
    }

    public InverseTransformableBase(Transformable head) {
        this.transformer = head.getTransformer();
    ...
    public void updateMatricesInverse(double delta, Transformable parent) {
        Matrix4f translation = transformer.getInverseTranslationMatrix4f();
        Matrix4f scale = transformer.getInverseScaleMatrix4f();
        Matrix4f rotation = transformer.getInverseRotationMatrix4f();
    ...
    public Transformable copy() {
        return new InverseTransformableBase(this);
    }
}
