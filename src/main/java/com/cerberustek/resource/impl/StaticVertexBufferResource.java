...
public class StaticVertexBufferResource implements VertexBufferResource {

    private final Vertex[] vertices;

    public StaticVertexBufferResource(Vertex[] vertices) {
        this.vertices = vertices;
    }

    @Override
    public VertexBuffer load() {
        StaticVertexBuffer vertexBuffer = new StaticVertexBuffer();
