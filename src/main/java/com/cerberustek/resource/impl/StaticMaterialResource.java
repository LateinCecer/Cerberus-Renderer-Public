...
public class StaticMaterialResource implements MaterialResource {

    private final Material material;

    public StaticMaterialResource(Material material) {
        this.material = material;
    }

    public StaticMaterialResource(TextureResource... textures) {
        material = new BaseMaterial();
        for (TextureResource r : textures)
            material.addTexture(r);
    }
