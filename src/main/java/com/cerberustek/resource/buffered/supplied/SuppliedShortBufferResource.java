...
public class SuppliedShortBufferResource extends ShortBufferResource implements BufferedSupplierResource<ShortBuffer> {

    private final Supplier<ShortBuffer> supplier;

    public SuppliedShortBufferResource(Supplier<ShortBuffer> supplier) {
