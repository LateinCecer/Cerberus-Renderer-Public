...
public class SuppliedByteBufferResource extends ByteBufferResource implements BufferedSupplierResource<ByteBuffer> {

    private final Supplier<ByteBuffer> supplier;

    public SuppliedByteBufferResource(Supplier<ByteBuffer> supplier) {
