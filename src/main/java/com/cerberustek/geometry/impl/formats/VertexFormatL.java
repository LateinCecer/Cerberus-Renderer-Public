...
public class VertexFormatL implements VertexFormat {
    ...
    public VertexFormatL(DataType type, ComponentType componentType, int offset) {
        this.type = type;
    ...
    public void bind(int index) {
        glVertexAttribLFormat(index, type.getNumComponents(), componentType.getGlId(), offset);
    }
