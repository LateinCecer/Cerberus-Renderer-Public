...
public class VertexFormatI implements VertexFormat {
    ...
    public VertexFormatI(DataType type, ComponentType componentType, int offset) {
        this.type = type;
    ...
    public void bind(int index) {
        glVertexAttribIFormat(index, type.getNumComponents(), componentType.getGlId(), offset);
    }
