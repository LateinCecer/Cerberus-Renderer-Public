...
import com.cerberustek.events.WindowIconifyEvent;
import com.cerberustek.window.Window;
import org.lwjgl.glfw.GLFWWindowIconifyCallback;

public class WindowIconifyCallback extends GLFWWindowIconifyCallback implements CerberusCallback {
    ...
    public void invoke(long window, boolean icon) {
        CerberusRegistry.getInstance().getService(CerberusEvent.class).executeFullEIF(
                new WindowIconifyEvent(window, icon));
    }
}
