...
public class GuiInteractionEvent implements Event {

    private final OverlayFrame frame;
    private final OverlayInteraction interaction;

    public GuiInteractionEvent(OverlayFrame frame, OverlayInteraction interaction) {
        this.frame = frame;
    ...
    public OverlayInteraction getInteraction() {
        return interaction;
    }
}
